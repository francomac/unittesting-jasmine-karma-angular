...
describe('Async Testing Examples', () => {
	...
	it(
		'Asynchrounous test example - setTimeout()',
		fakeAsync(() => {
			let test = false;
	...
	it(
		'Asynchronous test example - plain Promise',
		fakeAsync(() => {
			let test = false;
	...
	it(
		'Asynchronous test example - Promises + setTimeout()',
		fakeAsync(() => {
			let counter = 0;
	...
	it(
		'Asynchronous test example - Observables',
		fakeAsync(() => {
			let test = false;
